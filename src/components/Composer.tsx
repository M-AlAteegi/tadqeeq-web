...
// Bootstrap "upload" icon — unified across sidebar Upload File, analysis
// doc bar, and chat composer attach so the affordance reads the same
// everywhere users encounter it.
const ICON_ATTACH = (
